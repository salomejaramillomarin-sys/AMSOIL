...
class ProductoSerializer(serializers.ModelSerializer):
    factor = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False)
    costo = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False)
...
class FacturaLineaSerializer(serializers.ModelSerializer):
    reciclaje = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False, allow_null=True)
    petroleo = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False, allow_null=True)
    grasa = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False, allow_null=True)
    ivu = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False, allow_null=True)
    costo = serializers.DecimalField(max_digits=10, decimal_places=2, coerce_to_string=False)
...
class FacturaCreateSerializer(serializers.Serializer):
    empleado = serializers.CharField(max_length=100, required=False, allow_blank=True, default="")
